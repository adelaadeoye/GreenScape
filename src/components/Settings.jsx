...
export default function Settings({ paramValues, show, setShow }) {
  const [profile, setProfile] = useState({
    ...
    telephone: paramValues.currentUser.telephone
      ? paramValues.currentUser.telephone
      : "",
  });
  ...
  const handleDone = () => {
    ...
    setProfile({ image: "", fName: "", lName: "", telephone: "" });
    setShow(false);
  };
  useEffect(() => {
    show &&
      setProfile({
        image: paramValues.currentUser.image
          ? paramValues.currentUser.image
          : "",
        fName: paramValues.currentUser.fName
          ? paramValues.currentUser.fName
          : "",
        lName: paramValues.currentUser.lName
          ? paramValues.currentUser.lName
          : "",
        telephone: paramValues.currentUser.telephone
          ? paramValues.currentUser.telephone
          : "",
